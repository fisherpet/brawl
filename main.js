...
function ctnone() {
    $(".cgbq").fadeOut(500);
    $(".ctn1").fadeOut(500);
    $(".coinsgemsboth").fadeOut(500, function() {

        if (CGBS == "COINS") {
            $(".coinschoose").fadeIn(500).css("display", "flex");
            $(".coinschooseH").fadeIn(500);
        } else if (CGBS == "GEMS") {
            $(".gemschoose").fadeIn(500).css("display", "flex");
            $(".gemschooseH").fadeIn(500);
        } else {
            $(".bothchooseH").fadeIn(500);
            $(".coinschoose").fadeIn(500).css("display", "flex");
            $(".gemschoose").fadeIn(500).css("display", "flex");
        }
    ...
    $(".start").fadeOut(500, function() {
        ...
        var TYPEDO = {
            ...
            onComplete: function() {
                ...
                $(".ch3").fadeOut(500, function() {
                    $(".cgbq").fadeIn(500);
                    $(".coinsgemsboth").fadeIn(500).css("display", "flex");
                })
...
function afterchoose() {
  ...
  setTimeout(function() {
    var TYPEDO2 = {
        strings: ["<f700 class='c-yellow'>$~BRWL_HCK> </f700>You selected <cwhite class='f-500'>[" + NICETEXT + "]</cwhite>^500.^500.^500.^2000 Adding that to your account^500.^500.^500.^2000", "<f700 class='c-yellow'>$~BRWL_HCK> </f700>Deleting traces of hacking process^500.^500.^500.^2000", "<f700 class='c-yellow'>$~BRWL_HCK> </f700><cred class='f-600'>Automatic verification failed^500.^500.^500.^1500 <br>You need to perform manual verification.^1500 <br><f700>Complete the survey below to complete</f700>^500.^500.^500.^2000</cred>"],
        typeSpeed: 20, //20
        backSpeed: 20, //20
        showCursor: false,
        onComplete: function() {
